...
numbers[5] = 60; 
console.log(numbers);
প্রোগ্রামিংয়ের ভাষায় একে বলা হয় "Array with Constructor" বা "Array Object"। যেহেতু  এখানে new Array(5) দিয়ে একটি অবজেক্ট তৈরি করে তারপর ম্যানুয়ালি ইনডেক্স ধরে ধরে উপাদান বা ভ্যালু অ্যাসাইন করেছেন,
...
এক এক করে ০ থেকে ৫ নম্বর ইনডেক্স পর্যন্ত ডাটা ঢোকানো হল। জাভাস্ক্রিপ্ট দেখলো, "আচ্ছা, নতুন ডাটা আসছে!" সে মেমোরির সাইজ এক এক করে বাড়িয়ে প্রতিটা সংখ্যাকে তার সঠিক ঘরে বসিয়ে দিল। এটি একটি ডাইনামিক অ্যারে হিসেবে কাজ করেছে।
