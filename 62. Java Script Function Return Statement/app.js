...
function এর মধ্যে return এ যাই করা হক সেই  return করা জিনিস গুলা কি function নাম এ অ্যাড হয়

সহজ এবং সরাসরি উত্তর হলো: না, রিটার্ন করা জিনিসটা কখনোই সরাসরি ফাংশনের নামের সাথে আউটার মেমরিতে স্থায়ীভাবে যুক্ত (Add) বা জমা হয়।

যখনই ব্র্যাকেট দিয়ে তাকে কল করা হসছে (sayHello()), তখনই সে সচল হচ্ছে এবং ওই মুহূর্তে ভেতর থেকে যে জিনিসটা তৈরি করে ছুড়ে দিচ্ছে (যেমন: "Hello World"), কোডের ওই জায়গায় ঠিক সেটাই এসে বসে যাচ্ছে।

আর এই কারণেই console.log(sayHello()); করলে স্ক্রিনে ওই ফেরত আসা জিনিসটা অর্থাৎ Hello World দেখাচ্ছে।

যখন জাভাস্ক্রিপ্ট এই লাইনটা রান করে: console.log(sayHello());

সে দেখে  ফাংশনের নামের পাশে ব্র্যাকেট দিয়েছ—sayHello()। ব্র্যাকেট দেওয়া মানেই হলো মেশিনটা চালু বা কল (Call) করেছ।

জাভাস্ক্রিপ্ট ফাংশনের ভেতরে যায় এবং দেখে সেখানে লেখা আছে return "Hello World";।

ফাংশন তখন মেমরিতে "Hello World" লেখাটা তৈরি করে বাইরে ছুড়ে মারে।

ম্যাজিক মুহূর্ত: ঠিক ওই সেকেন্ডে, কোডের ওই জায়গায় sayHello() লেখাটি ভ্যানিশ (উধাও) হয়ে যায় এবং তার জায়গায় ফাংশন থেকে ছুড়ে মারা মান "Hello World" বসে পড়ে।


📦 তাহলে ফাংশনের নামের ভেতরে কী থাকে?

ফাংশনের নাম sayHello আসলে একটা ভেরিয়েবলের মতোই, তবে সে কোনো সাধারণ ডাটা (যেমন স্ট্রিং বা নাম্বার) ধরে রাখে না। সে ধরে রাখে পুরো ফাংশনের কোডটার একটা অ্যাড্রেস বা ঠিকানা।

যদি ব্র্যাকেট না দিয়ে শুধু ফাংশনের নামটা প্রিন্ট করা হয়

console.log(sayHello); // লক্ষ্য করা হক, কোনো ব্র্যাকেট দেওয়া হয়নি!

তখন জাভাস্ক্রিপ্ট কোনো "Hello World" দেখাবে না। সে পুরো ফাংশনের বডিটা (কোডটা) স্ক্রিনে এনে দেখাবে: f sayHello() { return "Hello World"; }।
কারণ ব্র্যাকেট না দিলে ফাংশন রান হয় না, আর রান না হলে সে কিছু return-ও করতে পারে না।




যতবার  ওই ফাংশনটাকে ব্র্যাকেট দিয়ে কল করা হবে (sayHello()), ততবার সে রান হবে এবং ভেতর থেকে যে মানটা return করা হয়েছে, ঠিক সেই মানটাই ওই জায়গায় এসে বসে যাবে।
...
যতবার কল করবে, কোডের ওই জায়গায় getFinalPrice() লেখাটা সাময়িকভাবে উধাও হয়ে গিয়ে সেখানে 575 বসে যাবে।
...
যখনই নামের পাশে ব্র্যাকেট () দিচ্ছ, জাভাস্ক্রিপ্ট মেমরির ওই ঠিকানায় ছুটে যাচ্ছে, ভেতরের কোডটুকু রান করছে, আর বের হওয়ার সময় return করা মানটি (575) এনে ওই লাইনে বসিয়ে দিচ্ছে।
কাজ শেষ হওয়া মাত্রই ওই ফাংশনের ভেতরের লোকাল ভেরিয়েবলগুলো (price, tax, total) মেমরি থেকে মুছে যায়




যদি return হওয়া সেই total ভ্যালুটা নিজের কাছে রেখে দিতে চাও (যাতে পরে যেকোনো জায়গায় ব্যবহার করা যায়),
